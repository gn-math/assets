...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/BuildPvzFusiom.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/BuildPvzFusiom.data.unityweb',
                        frameworkUrl: 'Build/BuildPvzFusiom.framework.js.unityweb',
                        codeUrl: 'Build/BuildPvzFusiom.wasm.unityweb',
